...
// Dependency-isolation guard for stickfighter.js: Stick Fighter 2000 — linted as the ASSEMBLED artifact, covering every stickfighter/ part (sfBridge in desktop.js → openStickFighter).
...
test('stickfighter.js references no app.js/lib globals (everything comes via the api bridge)', () => {
  assertChunkIsolated('stickfighter.js');
});
